...
\item Levande celler ska ha den vackra rosa\footnote{\url{https://www.dsek.se/api/pdf/styrdokument/releases/download/latest/riktlinje_for_grafisk_profil.pdf}} RGB-färgen \code{(242, 128, 161)}.
